...
const createStyles = (colors: AppColors) => StyleSheet.create({
  ...
  submit: { backgroundColor: colors.accent, padding: 15, alignItems: 'center', borderRadius: appRadius.small, marginTop: 18 },
  submitText: { color: colors.black, fontWeight: '900', fontSize: 13 },
