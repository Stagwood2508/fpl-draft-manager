...
const createStyles = (colors: AppColors) => StyleSheet.create({
  ...
  periodSwitch: { flexDirection: 'row', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: appRadius.pill, padding: 3 }, periodButton: { paddingHorizontal: 12, paddingVertical: 7, borderRadius: appRadius.pill }, periodButtonActive: { backgroundColor: colors.accentFill }, periodText: { color: colors.textMuted, fontSize: 11, fontWeight: '800' }, periodTextActive: { color: colors.accentForeground },
  ...
  managerStats: { flexDirection: 'row', marginTop: 12, backgroundColor: colors.backgroundElevated, borderRadius: appRadius.small, paddingVertical: 9 }, miniStat: { flex: 1, alignItems: 'center', borderRightWidth: StyleSheet.hairlineWidth, borderRightColor: colors.border }, miniValue: { color: colors.textPrimary, fontSize: 14, fontWeight: '900' }, miniLabel: { color: colors.textMuted, fontSize: 9, fontWeight: '700', marginTop: 1 }, formRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 10 }, formDot: { width: 22, height: 22, borderRadius: 11, alignItems: 'center', justifyContent: 'center' }, formWin: { backgroundColor: colors.accentFill }, formDraw: { backgroundColor: colors.textMuted }, formLoss: { backgroundColor: colors.danger }, formText: { color: colors.accentForeground, fontSize: 9, fontWeight: '900' }, openProfile: { marginLeft: 'auto', flexDirection: 'row', alignItems: 'center', gap: 2 }, openProfileText: { color: colors.accent, fontSize: 9, fontWeight: '900' },
