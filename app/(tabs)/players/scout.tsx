          ...
          <View style={[styles.modalContent, isMobileLayout && styles.modalContentMobile, isMobileLayout && { paddingTop: Math.max(safeArea.top, 8), paddingBottom: Math.max(safeArea.bottom, 8) }]}>
            ...
            <View style={styles.modalActionRow}>
              ...
              <TouchableOpacity style={[styles.modalButton, styles.modalButtonConfirm, !selectedRosterPlayerId && styles.modalButtonDisabled]} disabled={!selectedRosterPlayerId || submittingWaiver} onPress={handleSubmitWaiverClaim}>
                {submittingWaiver ? <ActivityIndicator size="small" color={colors.accentForeground} /> : <Text style={styles.modalButtonConfirmText}>Create Claim</Text>}
              </TouchableOpacity>
            </View>
          </View>
        </View>
...
const createStyles = (colors: AppColors) => StyleSheet.create({
  ...
  filterButtonTextActive: { color: colors.accentForeground },
  ...
  watchlistBtnActive: { backgroundColor: colors.accentFill, borderColor: colors.accent },
  waiverClaimAddBtn: { width: 36, height: 28, backgroundColor: colors.accentFill, borderRadius: 4, justifyContent: 'center', alignItems: 'center' },
  ...
  segmentButtonActive: { backgroundColor: colors.accentFill, borderColor: colors.accent },
  segmentButtonText: { color: colors.textSecondary, fontSize: 10, fontWeight: '800', textAlign: 'center' },
  segmentButtonTextActive: { color: colors.accentForeground, fontWeight: '900' },
  ...
  optionButtonActive: { backgroundColor: colors.accentFill, borderColor: colors.accent },
  optionButtonText: { color: colors.textSecondary, fontSize: 10, fontWeight: '800' },
  optionButtonTextActive: { color: colors.accentForeground, fontWeight: '900' },
  ...
  applyButton: { flex: 1, height: 40, borderRadius: 5, backgroundColor: colors.accentFill, alignItems: 'center', justifyContent: 'center' },
  applyButtonText: { color: colors.accentForeground, fontSize: 11, fontWeight: '900', textTransform: 'uppercase' },
  ...
  modalButtonConfirmText: { color: colors.accentForeground, fontWeight: '800', fontSize: 13 },
});
